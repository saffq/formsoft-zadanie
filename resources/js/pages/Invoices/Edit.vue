...
const form = useForm({
    ...
    seller_nip: props.invoice.seller_nip,
    buyer_nip: props.invoice.buyer_nip,
    product_name: props.invoice.product_name,
    net_amount: props.invoice.net_amount,
    issuance_date: props.invoice.issuance_date,
});
...
<template>
    <form @submit.prevent="submit" class="space-y-4">
        ...
        <div class="flex items-center justify-between">
            <button
                type="submit"
                class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-150"
